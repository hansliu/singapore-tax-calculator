<i18n>
{
  ...
  "zh-tw": {
    "intro": {
      "content": "歡迎來到 Singapore Tax Calculator。本網站想用最簡單的方式，讓想來新加坡工作或是已經在新加坡工作的工作簽證持有者，能快速瞭解您需要繳交多少個人所得稅。如果想知道更詳細的稅務資訊，請參考新加坡 IRAS 網站。如果對網站有什麼想法，也歡迎到最下方留言區留下您寶貴的意見。此外，根據統計，2019年新加坡人的平均年收入為 S$ 67,152 元"
    },
    "about": {
      "title": "關於 {website}",
      "content": "Singapore Tax Calculator 由 {author} 開發與維護。網站的頁面設計與程式碼參考自 {thanks_website} (由 {thanks_author} 和 Emi 開發與維護)，如果有任何計算上的錯誤，歡迎您直接檢查程式碼。如果有什麼新想法，在保持盡可能簡單的設計情況下，也歡迎到 {github} 提出建議或請求。"
    },
    "disclaimer": {
      "title": "免責聲明",
